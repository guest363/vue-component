...
Компоненту передается колличество выстрелов которые возможно занести на мишень и критерий оценки (упражнение).

При клике по мешени подсчитывается колличество набранных очков и выставляется оценка.
## Входные параметры
