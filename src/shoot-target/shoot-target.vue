<template>
<div class="shoot">
    <canvas height='630' width='630' id='target' v-on:click="setShoot"> Браузер не поддерживает canvas, обновитесь</canvas>
...
export default {
    ...
    methods: {
        ...
        getShootValue(x, y) {
            ...
            if ((x < 183 || x > 453) && y < 228 || y > 603 || x < 24 || x > 610) { // белые граници мишени
                return 0;
        ...
        setShoot() {
            if (this.data.count === this.shoot.count) {
